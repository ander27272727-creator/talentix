...
import {
  ...
  Settings, LogOut, Menu, X, ChevronRight, Sparkles, Bell,
  Search, FileText, Target, HelpCircle, CreditCard
} from "lucide-react"
...
const navigation = [
  ...
  { name: "Mi Empresa", href: "/company/profile", icon: Building2 },
  { name: "Vacantes", href: "/company/vacancies", icon: Briefcase },
  { name: "Candidatos", href: "/company/candidates", icon: Users },
  { name: "Pipeline", href: "/company/pipeline", icon: Target },
  { name: "Analytics", href: "/company/analytics", icon: BarChart3 },
  { name: "Facturación", href: "/company/billing", icon: CreditCard },
]

const bottomNav = [
  { name: "Configuración", href: "/company/settings", icon: Settings },
  { name: "Ayuda", href: "/company/help", icon: HelpCircle },
]
  ...
  return (
    <div className="min-h-screen bg-muted/30">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-background border-b z-50 flex items-center px-4">
        ...
        <Link href="/company" className="flex items-center gap-2 ml-4">
        ...
        <div className="h-16 bg-background border-b flex items-center justify-between px-6 sticky top-0 z-30">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <Avatar>
                <AvatarFallback className="bg-gradient-to-br from-fb-purple to-fb-blue text-white">
