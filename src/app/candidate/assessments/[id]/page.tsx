...
import {
  ...
  Target, Sparkles, AlertCircle, ChevronRight
} from "lucide-react"
          ...
          <CardContent className="p-8 text-center">
            ...
            <div className="mt-6 p-4 rounded-xl bg-white/60">
              ...
              <p className="text-sm text-muted-foreground">
                {overallScore >= 80
                  ? "¡Excelente! Tus resultados son sobresalientes. Esto mejorará significativamente tus matches."
                  : overallScore >= 60
                  ? "Buenos resultados. Continúa completando evaluaciones para mejorar tu perfil."
                  : "Tus resultados están por debajo del promedio. Considera practicar para mejorar."}
              </p>
            </div>
          </CardContent>
        </Card>
